...
export default function problemDbRepository(repository: ReturnType<typeof problemRepositoryMongoDB>) {
    ...
    const updateProblem = (id: string, problem: ReturnType<typeof Problem>) => repository.updateProblem(id, problem)

    const createProblem = (problem: ReturnType<typeof Problem>) => repository.createProblem(problem)
