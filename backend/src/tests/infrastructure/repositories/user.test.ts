...
import userRepositoryMongoDB, { IUserRepositoryImpl } from '../../../infrastructure/repositories/user';
...
describe('User Repository MongoDB Tests', () => {
  ...
  describe('findById', () => {
    it('should find user by id', async () => {
      ...
      expect(mockedUserModel.findById).toHaveBeenCalledWith('6570a0ae7416e1bcf1ec3dd6');
