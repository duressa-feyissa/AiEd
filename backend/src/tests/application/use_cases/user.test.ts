...
describe('User Use Cases', () => {
  ...
  describe('viewAllUsers', () => {
    ...
    it('should return the users', async () => {
      ...
      expect(result[0]).toHaveProperty('image', 'https://res.cloudinary.com/123.jpg');
      expect(result[0]).toHaveProperty('cover', 'https://res.cloudinary.com/123.jpg');
  ...
  describe('removeUser', () => {
      ...
      it('should return the deleted user', async () => {
        ...
        expect(result).toHaveProperty('image', 'https://res.cloudinary.com/123.jpg');
        expect(result).toHaveProperty('cover', 'https://res.cloudinary.com/123.jpg');
