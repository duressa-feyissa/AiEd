...
import 'package:mobile/features/ed_ai/presentations/screen/onboarding/contest.dart';
import 'package:mobile/features/ed_ai/presentations/screen/onboarding/innovate.dart';
import 'package:mobile/features/ed_ai/presentations/screen/onboarding/join.dart';
import 'package:mobile/features/ed_ai/presentations/screen/onboarding/learning.dart';
import 'package:mobile/features/ed_ai/presentations/screen/onboarding/slider.dart';
import 'package:mobile/features/ed_ai/presentations/screen/onboarding/starter.dart';
...
class _OnboardingLayoutState extends State<OnboardingLayout> {
  ...
  void onChange(int index) {
    if (index == 5) {
      Navigator.pushNamed(context, '/EntranceLayout');
    } else if (index < 5) {
      setState(() {
        this.index = index;
      });
